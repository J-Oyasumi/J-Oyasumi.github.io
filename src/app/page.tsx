...
import type { ExperienceItem } from '@/components/home/Experience';
import type { MiscItem } from '@/components/home/Misc';
...
function processSections(sections: SectionConfig[], locale?: string): SectionConfig[] {
  return sections.map((section: SectionConfig) => {
    switch (section.type) {
      ...
      case 'experience': {
        const experienceData = section.source ? getTomlContent<{ experience: ExperienceItem[] }>(section.source, locale) : null;
        return {
          ...section,
      ...
      case 'misc': {
        const miscData = section.source ? getTomlContent<{ misc: MiscItem[] }>(section.source, locale) : null;
        return {
          ...section,
